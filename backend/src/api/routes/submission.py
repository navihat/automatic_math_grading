...
from src.services.grading import grade_submission
...
async def regrade_submission(submission_id: int, db: Session = Depends(get_db)):
    ...
    """
    from src.services.submission import get_submission_by_id
    from src.services.ai.step_grader import grade_student_work
